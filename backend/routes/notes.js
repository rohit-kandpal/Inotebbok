...
router.post('/addnote', fetchuser, [
    ...
    body('description','description must be atleast 5 chracters').isLength({min: 5}),], async (req, res)=>{
    try{
...
// ROUTE 3: Update and existing note using: PUT "/api/notes/getuser" . Login required
